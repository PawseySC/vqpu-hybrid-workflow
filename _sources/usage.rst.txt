...
Services to run QbitBridge
==========================

Using Launcher 
--------------

The key services, Postgres and Prefect, can be started using ``launcher.py`` with a yaml config file. 
An example is found in :file:`examples/launcher_config/example.yaml`. Launch using 
